...
- Communicates with a local server running on `http://localhost:3000/send-message` [API Bridge Chrome Extension for ChatGPT(Web)](https://github.com/tylercode362/Chrome-extension-ChatGPT-API)
